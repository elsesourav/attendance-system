    ...
    <div className="space-y-6">
      ...
      {isLoading ? (
        ...
        <div className="text-center py-10">
          <p className="text-muted-foreground mb-4">You are not enrolled in any streams yet.</p>
          <p className="text-sm text-muted-foreground">Please contact your teacher to be enrolled in a stream.</p>
        </div>
      ) : (
